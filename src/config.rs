...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(),"Txy@012397".to_string());
        RwLock::new(map);
    }
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["118.31.42.84"];
pub const RS_PUB_KEY: &str = "35wmL9VUBQj5E4wk9mxDMBgE2RzdD4LJZMAMIKVm+GQ=";
